          ...
          <div className="w-7/12">
            <div className="flex gap-4 mb-4">
              <input
                ...
                className="p-3 w-6/12 outline outline-1 outline-white/50 bg-transparent rounded-lg"
              />
              <input
                type="text"
                name="lastName"
            ...
            <div className="flex w-[100px] gap-4 mb-4">
              <button className="p-3 w-full bg-blue-500 text-white rounded-lg outline outline-1 outline-white/50">
                Submit
              </button>
            </div>
          </div>
