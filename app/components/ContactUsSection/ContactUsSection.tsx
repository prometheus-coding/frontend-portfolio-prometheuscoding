  ...
  return (
    <Section sectionHeight="h-screen" bgColor="bg-primary-200">
      <div className="centered">
        <div className="pb-3 text-2xl w-full sm:w-4/12">
          ...
          <div className="w-full sm:w-7/12">
            <div className="flex flex-wrap sm:flex-nowrap gap-4 mb-4">
              <input
                ...
                className="p-3 w-full sm:w-6/12 outline outline-1 outline-white/50 bg-transparent rounded-lg"
              />
              <input
                type="text"
                name="lastName"
            ...
            <div className="flex gap-4 mb-4">
              <button className="p-3 w-full sm:w-[100px] bg-blue-500 text-white rounded-lg outline outline-1 outline-white/50">
                Submit
              </button>
            </div>
          </div>
          <div className="w-full sm:w-5/12 flex justify-end items-center mt-6 sm:mt-0">
